...
<?php echo $this->Form->create('Infringement',array('controller'=>'teams','method'=>'post','action'=>'addevalution')); ?>
 ...
 <?php echo $this->Form->input('emp_id',array('label'=>'','id'=>'emp_id','type'=>'hidden'));?> 
  <?php echo $this->Form->input('emp_name',array('label'=>'','id'=>'emp_name','type'=>'hidden'));?> 

<tr class="altrow"><td><b> 1.</b> Percentage of total projects delivered on time <font  size= "3" color="red">*</font> </td>
<td> <?php $options=array('k'=>'','0'=>'0','1.0'=>'1.0','1.5'=>'1.5','2.0'=>'2.0','2.5'=>'2.5','3.0'=>'3.0','3.5'=>'3.5','4.0'=>'4.0','4.5'=>'4.5','5.0'=>'5.0','5.5'=>'5.5','6.0'=>'6.0','6.5'=>'6.5','7.0'=>'7.0','7.5'=>'7.5','8.0'=>'8.0','8.5'=>'8.5','9.0'=>'9.5','10'=>'10'); ?>
