...
var id=document.getElementById("hello1").value;
window.focus(); 
var jm="http://192.168.0.184/greyb/projects/coment/"+id;
window.open(jm);
this.cancel(); 
...
?>       
		...
		<li><?php echo $this->Html->link(__('News Feed', true), array('controller' => 'projects', 'action' => 'news')); ?> </li>
<?php 
}
