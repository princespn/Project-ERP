...
?>
		...
		<td><?php echo date('d-m-Y', strtotime($project['Project']['start_date'])); ?>&nbsp;</td>
		<td><?php echo date('d-m-Y', strtotime($project['Project']['end_date'])); ?>&nbsp;</td>
		<td class="actions"><?php echo $this->Html->link(__('Comment', true), array('action' => 'comentc', $project['Project']['id'])); ?></td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'viewc', $project['Project']['id']));
	    }
			?>
					</td>
<?php 
...
?>
		...
		<td><?php echo $project['Project']['project_name']; ?>7&nbsp;</td>
...
?>
		...
		<li><?php echo $this->Html->link(__('Employee Evalutions', true), array('controller' => 'users', 'action' => 'team')); ?> </li>
<?php 
}
 elseif($session->read('Auth.User.group_id')=='2')
{
