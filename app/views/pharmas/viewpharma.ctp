...
<tr class="altrow"><td><div style="height:50px;"><b> 35.</b>Average rating for project quality (given by mentor)</div></td> </tr>
...
<?php 
 ...
 if($pharma['Pharma'][$hello[0]]>=9 && $pharma['Pharma'][$hello[1]]>=9 && $pharma['Pharma'][$hello[2]]==0 && $pharma['Pharma'][$hello[3]]=="yes" && $pharma['Pharma'][$hello[4]]=="yes" && $pharma['Pharma'][$hello[5]]=="yes" && $pharma['Pharma'][$hello[6]]==0 && $pharma['Pharma'][$hello[7]]==0 && $pharma['Pharma'][$hello[8]]=="yes" && $pharma['Pharma'][$hello[9]]=="no" && $pharma['Pharma'][$hello[10]]=="no" && $pharma['Pharma'][$hello[11]]=="yes" && $pharma['Pharma'][$hello[12]]=="yes" && $pharma['Pharma'][$hello[13]]=="no" && $pharma['Pharma'][$hello[14]]=="formal" && $pharma['Pharma'][$hello[15]]=="formal" && $pharma['Pharma'][$hello[16]]==0 && $pharma['Pharma'][$hello[17]]=="yes" && $pharma['Pharma'][$hello[18]]=="yes" && $pharma['Pharma'][$hello[19]]=="yes" && $pharma['Pharma'][$hello[20]]=="yes" && $pharma['Pharma'][$hello[21]]=="yes" && $pharma['Pharma'][$hello[22]]>=3 && $pharma['Pharma'][$hello[23]]=="green" && $pharma['Pharma'][$hello[24]]=="yes" && $pharma['Pharma'][$hello[33]]>=8) 
{
  if($pharma['Pharma'][$hello[25]]=="yes" && $pharma['Pharma'][$hello[26]]=="yes" && $pharma['Pharma'][$hello[27]]=="yes" && $pharma['Pharma'][$hello[28]]=="yes" && $pharma['Pharma'][$hello[29]]=="yes" && $pharma['Pharma'][$hello[30]]=="yes" && $pharma['Pharma'][$hello[33]]>=9.5)
    {
      if($pharma['Pharma'][$hello[31]]=="yes" && $pharma['Pharma'][$hello[32]]=="yes" && $pharma['Pharma'][$hello[33]]==10)
        {
...
<td><div style="height:50px; width:250px;ooverflow-y:scroll;overflow-x:hidden;"> <b> <font color="blue" ><?php echo $pharma['Pharma'][$hello[$i]]; ?> </font> </b> :: <?php echo $pharma['Pharma'][$hello[$i+34]]; ?>   </td>  
