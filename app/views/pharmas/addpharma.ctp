...
<?php echo $this->Form->create('Pharma',array('controller'=>'teams','method'=>'post','action'=>'addpharma')); ?>
	<fieldset>
 ...
 <?php echo $this->Form->input('user_id');?> 
  <?php echo $this->Form->input('team_id',array('label'=>'','id'=>'team_id','type'=>'hidden','value'=>'3'));?> 
