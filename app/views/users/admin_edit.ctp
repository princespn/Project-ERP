<div class="user form">
	<table>
		<tr>
			<td><h2><?php __('Edit User Details'); ?></h2></td>
	...
	<?php echo $this->Form->create('User', array('url' => array('plugin'=>null,'controller' => 'user', 'action' => 'edit'))); ?> 
	<?php
		...
		<br />
		<?php 
		echo $this->Form->input('old_password',array('type'=>'password', 'autocomplete'=>'off'));
		echo $this->Form->input('password',array('type'=>'password', 'autocomplete'=>'off'));
		echo $this->Form->input('password_confirm', array('type'=>'password', 'autocomplete'=>'off'));
		?>
